...
export default axios.create({
    ...
    //we need to include this http header setting in order for our client HTTP requests to not be blocked by cors because the relevant web API is running in a different domain, or origin.
})
